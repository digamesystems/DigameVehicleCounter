...
const String SW_VERSION       = "0.9.85";
const String TERSE_SW_VERSION = "0985";  
 ...
 * 
 * 0.9.85 -  Changes to support AP mode when running as a WiFi counter. (Network configuration)
 */
